...
object CountryCardRepository extends Repository[CountryCard] {
  ...
  override protected val cards: Seq[CountryCard] = Seq(CountryCard("서울", 1000, 1000),
    ...
    CountryCard("부산", 1000, 1000), CountryCard("파주", 1000, 1000), CountryCard("화성", 1000, 1000),
    CountryCard("울산", 1000, 1000), CountryCard("부안", 1000, 1000), CountryCard("군산", 1000, 1000),
    CountryCard("인천", 1000, 1000), CountryCard("나주", 1000, 1000), CountryCard("안성", 1000, 1000)
  )
}
